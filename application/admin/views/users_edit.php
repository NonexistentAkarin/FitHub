            ...
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                    ...
                    if ($id == '') {
                        ...
                        ?>
                        <li class="active"><a
                                href="<?php echo '#/users?m=edit&id=' . $id; ?>"><?php echo $header; ?></a></li>
                ...
                <div class="tab-content">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="status" id="status">
                            ...
                            <option value="0" <?php echo $status === 0 ? 'selected="selected"' : ''; ?>>Diactive
                            </option>
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select multiple="multiple" name="roles[]" class="form-control select2" style="width:100%;">
                            ...
                            foreach ($roles as $role) {
                                ?>
                                <option
                                    value="<?php echo $role->id; ?>" <?php echo in_array($role->id, $userRoles) ? 'selected="selected"' : ''; ?>><?php echo $role->roleName; ?></option>
                                <?php
                            }
                            ?>
                        </select>
                    ...
                    if ($id != '') {
                        ?>
                        <p class="page-header">User Permissions <a href="#/users?m=set_perms&user_id=<?php echo $id; ?>"
                                                                   title="Change Permissions"><i class="fa fa-gear"></i></a>
                        </p>
                        <div class="form-group">
                            <ul>
                                <?php
