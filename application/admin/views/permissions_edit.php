        ...
        <div class="col-xs-12">
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                    ...
                    if ($id == '') {
                        ?>
                        <li class="active"><a href="<?php echo '#/permissions?m=add'; ?>"><?php echo $header; ?></a>
                        </li>
                        <?php
                    } else {
                        ?>
                        <li class="active"><a
                                href="<?php echo '#/permissions?m=edit&id=' . $id; ?>"><?php echo $header; ?></a></li>
                        <?php
                    }
                    ?>
                ...
                <div class="tab-content">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="permKey" value="<?php echo $permKey; ?>"
                               class="form-control auto-slug"/>
