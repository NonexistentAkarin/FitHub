            ...
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                    ...
                    if ($id == '') {
                        ...
                        ?>
                        <li class="active"><a
                                href="<?php echo '#/roles?m=edit&id=' . $id; ?>"><?php echo $header; ?></a></li>
                        <?php
                    }
                    ?>
                ...
                <div class="tab-content">
                    ...
                    <div class="form-group">
                        ...
                        All Node <a href="javascript:;" id="expandAllBtn">expand</a> | <a href="javascript:;"
                                                                                          id="collapseAllBtn">collapse</a>
                        | <a href="javascript:;" class="checkall" data-type="1">All Allow</a> | <a href="javascript:;"
                                                                                                   class="checkall"
                                                                                                   data-type="0">All
                            Deny</a> | <a href="javascript:;" class="checkall" data-type="x">All Ignore</a>
