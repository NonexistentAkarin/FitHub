...
<section class="content-header">
    <h1>
        My Moments
        <small>See what you share</small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">My Moments</li>
    </ol>
</section>
        ...
        <div class="col-md-12">
            <form role="form" action="admin.php?c=SocialMediaFormHelper&m=releaseDynamic" method="post">
                ...
                <div class="form-group">
                    <textarea class="form-control" rows="3" placeholder="Share your moments here"
        ...
        <div class="box box-widget">
            ...
            <div class="box-header with-border">
                <div class="user-block">
                    <img class="img-circle" src="<?php echo base_url(); ?>resource/adminlte/dist/img/user9-894x893.png"
                         alt="User Image">
                    ...
                    <div class="form-group margin-bottom-none">
                        ...
                        <div class="col-sm-2">
                            <button type="button" class="btn btn-danger pull-right btn-block btn-sm"
                                    onclick="releaseComment(this);">Add a commment
                            </button>
                        </div>
                    </div>
                </form>
...
<template id="commentItem">
    <div class="box-comment">
        <!-- User image -->
        <img class="img-circle img-sm" src="<?php echo base_url(); ?>resource/adminlte/dist/img/user9-894x893.png"
             alt="User Image">
...
<script>
    ...
    function updateDynamic() {
        $.ajax({
            type: "POST",  //提交方式
            url: "admin.php?c=socialMediaAjaxHelper&m=getCurrentUserDynamic",//路径
