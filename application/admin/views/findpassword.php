...
<div class="login-box">
    <div class="login-logo">
        <a href="<?php echo site_url(''); ?>">FitHub</a>
    </div>
    <!-- /.login-logo -->
    <div class="login-box-body">
        <p class="login-box-msg">Enter your username or email address and we will send you a link to reset your
            password.</p>
        ...
        <div class="form-group">
            <div class="row">
                <div class="col-lg-7">
                    <input type="text" class="form-control" required name="captcha_code" id="captcha_code"
                           placeholder="Captcha Code"><span id="captcha_codeerror"></span>
                </div>
                <div class="col-lg-5">
                    <img src="<?php echo base_url(); ?>api/captcha"
                         onclick="this.src='<?php echo base_url(); ?>api/captcha?_t=' + Math.random();"
...
<!-- jQuery 2.1.4 -->
<script src="<?php echo base_url(); ?>resource/adminlte/plugins/jQuery/jQuery-2.1.4.min.js"
